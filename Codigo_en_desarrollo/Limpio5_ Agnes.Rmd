...
```
#Al realizar las respectivas pruebas a las variables indepedientes, notamos que el mejor metodo de conglomeración para nuestros elementos es jerarquica aglomerativa.